...
abstract final class StgPortfolioPricing {
  static const Map<StgPortfolioAppId, StgAppPricing> byApp = {
    ...
    StgPortfolioAppId.checklist: StgAppPricing(
      ...
      trialDays: 14,
      trialPriceLabel: r'$0',
      standardPriceLabel: r'$9.99/month or $99.00/year',
      premiumPriceLabel: r'$24.99/month or $249.00/year',
    ...
    StgPortfolioAppId.taskapp: StgAppPricing(
      ...
      trialDays: 14,
      trialPriceLabel: r'$0',
      standardPriceLabel: r'$4.99/month or $49.00/year',
      premiumPriceLabel: r'$14.99/month or $149.00/year',
